...
int main() {
	...
	//-----------------------------------------------------------
	Shader shader("../../Shader/hdr_light_vs.glsl", "../../Shader/hdr_light_fs.glsl");
	Shader hdrShader("../../Shader/hdr_quad_vs.glsl", "../../Shader/hdr_quad_fs.glsl");
	...
	//这边改成16F，使得纹理存储的颜色信息可以是0-16中的浮点数，超出LDR的[0,1]范围
